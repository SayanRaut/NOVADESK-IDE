...
declare global {
  interface Window {
    electronAPI?: {
      ...
      gitLog: (maxCount?: number) => Promise<string | null>;
      gitBranches: () => Promise<string | null>;
      gitAdd: (filePath: string) => Promise<boolean>;
      gitAddFromDialog: () => Promise<boolean>;
      gitAddAll: () => Promise<boolean>;
      gitUnstage: (filePath: string) => Promise<boolean>;
      gitCommit: (message: string) => Promise<boolean>;
      gitPush: (branch: string) => Promise<boolean>;
      gitCheckout: (branch: string, isNew?: boolean) => Promise<boolean>;
      gitRemoteAdd: (url: string) => Promise<boolean>;
      gitRemoteRemove: () => Promise<boolean>;
      gitRemoteUrl: () => Promise<string | null>;
      openExternal: (url: string) => Promise<boolean>;
      gitDiffBranches: (base: string, compare: string) => Promise<string | null>;
