      ...
      <div className="relative rounded-lg bg-[#111111] border border-[var(--border-color)] focus-within:border-[var(--accent)] transition-ui flex flex-col">
        ...
        <div className="flex justify-between items-center px-2 pb-2">
          <div className="flex gap-2">
            <button type="button" onClick={() => setActiveBottomPanel('terminal')} title="Open terminal" className="text-gray-500 hover:text-gray-300 p-1 rounded hover:glass-panel transition-ui">
          ...
          <button 
            ...
            className={`p-1.5 rounded transition-ui ${
              input.trim() && !isThinking ? 'bg-blue-600 text-white hover:bg-blue-500' : 'glass-panel text-gray-600 cursor-not-allowed'
            }`}
          >
            <Send size={14} />
          </button>
