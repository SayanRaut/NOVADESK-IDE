export const LoadingScreen = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-screen glass-panel text-gray-200">
      <div className="flex flex-col items-center gap-6">
        <h1 className="text-5xl font-bold tracking-tighter text-blue-500 animate-pulse">NovaDesk</h1>
        
        <div className="flex flex-col items-center gap-2">
          <div className="w-48 h-1 glass-panel rounded-full overflow-hidden">
