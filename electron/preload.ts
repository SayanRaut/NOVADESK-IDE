...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  gitLog: (maxCount?: number) => ipcRenderer.invoke('git:log', maxCount),
  gitBranches: () => ipcRenderer.invoke('git:branches'),
  gitAdd: (filePath: string) => ipcRenderer.invoke('git:add', filePath),
  gitAddFromDialog: () => ipcRenderer.invoke('git:addFromDialog'),
  gitAddAll: () => ipcRenderer.invoke('git:addAll'),
  ...
  gitPush: (branch: string) => ipcRenderer.invoke('git:push', branch),
  gitCheckout: (branch: string, isNew: boolean = false) => ipcRenderer.invoke('git:checkout', branch, isNew),
  gitRemoteAdd: (url: string) => ipcRenderer.invoke('git:remoteAdd', url),
  gitRemoteRemove: () => ipcRenderer.invoke('git:remoteRemove'),
  gitRemoteUrl: () => ipcRenderer.invoke('git:remoteUrl'),
  openExternal: (url: string) => ipcRenderer.invoke('system:openExternal', url),
  gitDiffBranches: (base: string, compare: string) => ipcRenderer.invoke('git:diffBranches', base, compare),
